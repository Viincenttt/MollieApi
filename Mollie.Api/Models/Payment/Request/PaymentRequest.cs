...
namespace Mollie.Api.Models.Payment.Request {
    public class PaymentRequest {
        ...
        /// <summary>
        /// Oauth only - Optional - An optional routing configuration which enables you to route a successful payment, or part of the payment, to one or more connected accounts. Additionally, you can schedule (parts of) the payment to become available on the connected account on a future date.
        /// </summary>
        [JsonProperty("routing")]
        public IList<PaymentRouting> Routings { get; set; }
