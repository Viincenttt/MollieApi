...
namespace Mollie.Api.Client
{
	public class SettlementsClient : OauthBaseMollieClient, ISettlementsClient
	{
		...
		public async Task<ListResponse<SettlementResponse>> GetSettlementsListAsync(string reference = null, int? offset = null, int? count = null)
		{
		...
		public async Task<ListResponse<PaymentResponse>> GetSettlementPaymentsListAsync(string settlementId, int? offset = null, int? count = null)
		{
		...
		public async Task<ListResponse<RefundResponse>> GetSettlementRefundsListAsync(string settlementId, int? offset = null, int? count = null)
		{
		...
		public async Task<ListResponse<ChargebackResponse>> GetSettlementChargebacksListAsync(string settlementId, int? offset = null, int? count = null)
		{
