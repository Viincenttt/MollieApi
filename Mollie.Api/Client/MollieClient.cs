...
namespace Mollie.Api.Client {
    [Obsolete(
        "This class is deprecated, please use the new API specific clients, such as PaymentClient, CustomerClient etc")]
    public class MollieClient : IMollieClient {
        ...
        public MollieClient(string apiKey) {
            ...
            _issuerClient = new IssuerClient(apiKey);
        ...
        public async Task<ListResponse<PaymentResponse>> GetPaymentListAsync(int? offset = null, int? count = null) {
            return await _paymentClient.GetPaymentListAsync(offset, count);
        }
        ...
        public async Task<ListResponse<PaymentMethodResponse>> GetPaymentMethodListAsync(int? offset = null,
            int? count = null) {
            return await _paymentMethodClient.GetPaymentMethodListAsync(offset, count);
        }

        [Obsolete("This method is deprecated, please use PaymentMethodClient class")]
        public async Task<PaymentMethodResponse> GetPaymentMethodAsync(PaymentMethod paymentMethod) {
            return await _paymentMethodClient.GetPaymentMethodAsync(paymentMethod);
        }
        ...
        public async Task<ListResponse<IssuerResponse>> GetIssuerListAsync(int? offset = null, int? count = null) {
            return await _issuerClient.GetIssuerListAsync(offset, count);
        }

        [Obsolete("This method is deprecated, please use IssuerClient class")]
        public async Task<IssuerResponse> GetIssuerAsync(string issuerId) {
            return await _issuerClient.GetIssuerAsync(issuerId);
        }
        ...
        public async Task<CustomerResponse> CreateCustomerAsync(CustomerRequest request) {
            return await _customerClient.CreateCustomerAsync(request);
        }

        [Obsolete("This method is deprecated, please use CustomerClient class")]
        public async Task<CustomerResponse> GetCustomerAsync(string customerId) {
            return await _customerClient.GetCustomerAsync(customerId);
        }

        [Obsolete("This method is deprecated, please use CustomerClient class")]
        public async Task<ListResponse<CustomerResponse>> GetCustomerListAsync(int? offset = null, int? count = null) {
            return await _customerClient.GetCustomerListAsync(offset, count);
        }
        ...
        public async Task<MandateResponse> GetMandateAsync(string customerId, string mandateId) {
            return await _mandateClient.GetMandateAsync(customerId, mandateId);
        }

        [Obsolete("This method is deprecated, please use MandateClient class")]
        public async Task<ListResponse<MandateResponse>> GetMandateListAsync(string customerId, int? offset = null,
            int? count = null) {
            return await _mandateClient.GetMandateListAsync(customerId, offset, count);
        }

        [Obsolete("This method is deprecated, please use MandateClient class")]
        public async Task<MandateResponse> CreateMandateAsync(string customerId, MandateRequest request) {
            return await _mandateClient.CreateMandateAsync(customerId, request);
        }
        ...
        public async Task<ListResponse<SubscriptionResponse>> GetSubscriptionListAsync(string customerId,
            ...
            return await _subscriptionClient.GetSubscriptionListAsync(customerId, offset, count);
        }

        [Obsolete("This method is deprecated, please use SubscriptionClient class")]
        public async Task<SubscriptionResponse> GetSubscriptionAsync(string customerId, string subscriptionId) {
            return await _subscriptionClient.GetSubscriptionAsync(customerId, subscriptionId);
        }
