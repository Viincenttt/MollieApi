...
namespace Mollie.Api.Client.Abstract
{
	public interface ISettlementsClient
	{
		...
		/// </summary>
		/// <param name="reference">Optional – Use this parameter to filter for a settlement with a specific reference. The reference is visible on your bank statement and in emails. An example reference would be 1182161.1506.02.</param>
