...
namespace Mollie.Api.Client.Abstract {
    public interface IChargebacksClient {
        ...
        /// <returns></returns>
        Task<ListResponse<ChargebackResponse>> GetChargebacksListAsync(string paymentId, int? offset = null,
            int? count = null);
        ...
        /// <returns></returns>
        Task<ListResponse<ChargebackResponse>> GetChargebacksListAsync(int? offset = null, int? count = null,
            string oathProfileId = null, bool? oauthTestmode = null);
    }
}