...
namespace Mollie.Api.Client.Abstract
{
	public interface IChargebacksClient
	{
		...
		/// <summary>
		/// Retrieve all chargebacks for current payment profile (API keys) or the organization (OAuth). Listing the chargebacks can be done without knowing anything about the payments.
		/// </summary>
		/// <param name="offset">Optional – The number of objects to skip.</param>
		/// <param name="count">Optional – The number of objects to return (with a maximum of 250).</param>
