...
namespace Mollie.Api.Client {
    public class CustomerClient : BaseMollieClient, ICustomerClient {
        ...
        public async Task<MollieResult<CustomerResponse>> CreateCustomerAsync(
        ...
        public async Task<MollieResult<CustomerResponse>> UpdateCustomerAsync(
        ...
        public async Task<MollieResult> DeleteCustomerAsync(
        ...
        public async Task<MollieResult<CustomerResponse>> GetCustomerAsync(
            string customerId, bool testmode = false, CancellationToken cancellationToken = default) {
            ValidateRequiredUrlParameter(nameof(customerId), customerId);
        ...
        public async Task<MollieResult<CustomerResponse>> GetCustomerAsync(UrlObjectLink<CustomerResponse> url, CancellationToken cancellationToken = default) {
            return await GetAsync(url, cancellationToken: cancellationToken).ConfigureAwait(false);
        }

        public async Task<MollieResult<ListResponse<CustomerResponse>>> GetCustomerListAsync(UrlObjectLink<ListResponse<CustomerResponse>> url, CancellationToken cancellationToken = default) {
            return await GetAsync(url, cancellationToken: cancellationToken).ConfigureAwait(false);
        }

        public async Task<MollieResult<ListResponse<CustomerResponse>>> GetCustomerListAsync(
        ...
        public async Task<MollieResult<ListResponse<PaymentResponse>>> GetCustomerPaymentListAsync(
        ...
        public async Task<MollieResult<PaymentResponse>> CreateCustomerPayment(
