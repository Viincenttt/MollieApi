...
namespace Mollie.Api.Client.Abstract {
    public interface ISubscriptionClient : IBaseMollieClient {
        ...
        Task<MollieResult> CancelSubscriptionAsync(string customerId, string subscriptionId, bool testmode = false, CancellationToken cancellationToken = default);
        ...
        Task<MollieResult<SubscriptionResponse>> CreateSubscriptionAsync(string customerId, SubscriptionRequest request, CancellationToken cancellationToken = default);
        ...
        Task<MollieResult<SubscriptionResponse>> GetSubscriptionAsync(string customerId, string subscriptionId, bool testmode = false, CancellationToken cancellationToken = default);
        ...
        Task<MollieResult<ListResponse<SubscriptionResponse>>> GetSubscriptionListAsync(string customerId, string? from = null, int? limit = null, string? profileId = null, bool testmode = false, CancellationToken cancellationToken = default);
        Task<MollieResult<ListResponse<SubscriptionResponse>>> GetSubscriptionListAsync(UrlObjectLink<ListResponse<SubscriptionResponse>> url, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        /// <param name="cancellationToken">Token to cancel the request</param>
        /// <returns>A list of paginated subscriptions</returns>
        Task<MollieResult<ListResponse<SubscriptionResponse>>> GetAllSubscriptionList(string? from = null, int? limit = null, string? profileId = null, bool testmode = false, CancellationToken cancellationToken = default);
        Task<MollieResult<SubscriptionResponse>> GetSubscriptionAsync(UrlObjectLink<SubscriptionResponse> url, CancellationToken cancellationToken = default);
        ...
        Task<MollieResult<SubscriptionResponse>> UpdateSubscriptionAsync(string customerId, string subscriptionId, SubscriptionUpdateRequest request, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<MollieResult<ListResponse<PaymentResponse>>> GetSubscriptionPaymentListAsync(string customerId, string subscriptionId, string? from = null, int? limit = null, bool testmode = false, CancellationToken cancellationToken = default);
    }
}
