...
public interface IPayoutClient : IBaseMollieClient {
    ...
    /// </summary>
    Task<MollieResult<PayoutResponse>> CreatePayoutAsync(PayoutRequest request, CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<MollieResult<ListResponse<PayoutResponse>>> GetPayoutListAsync(
    ...
    /// </summary>
    Task<MollieResult<PayoutResponse>> GetPayoutAsync(string payoutId, bool testmode = false, CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<MollieResult<PayoutResponse>> CancelPayoutAsync(string payoutId, bool testmode = false, CancellationToken cancellationToken = default);
}
