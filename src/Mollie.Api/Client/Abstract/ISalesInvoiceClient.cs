...
public interface ISalesInvoiceClient : IDisposable {
    Task<MollieResult<SalesInvoiceResponse>> CreateSalesInvoiceAsync(
        SalesInvoiceRequest salesInvoiceRequest, CancellationToken cancellationToken = default);
    Task<MollieResult<ListResponse<SalesInvoiceResponse>>> GetSalesInvoiceListAsync(
    ...
    Task<MollieResult<SalesInvoiceResponse>> GetSalesInvoiceAsync(
    ...
    Task<MollieResult<SalesInvoiceResponse>> UpdateSalesInvoiceAsync(
        string salesInvoiceId, SalesInvoiceUpdateRequest salesInvoiceRequest, CancellationToken cancellationToken = default);
    Task<MollieResult> DeleteSalesInvoiceAsync(string salesInvoiceId, bool testmode = false, CancellationToken cancellationToken = default);
}
