...
namespace Mollie.Api.Client {
    public class OrganizationClient : OauthBaseMollieClient, IOrganizationClient {
        ...
        public async Task<MollieResult<OrganizationResponse>> GetCurrentOrganizationAsync(CancellationToken cancellationToken = default) {
            return await GetAsync<OrganizationResponse>($"organizations/me", cancellationToken: cancellationToken).ConfigureAwait(false);
        }

        public async Task<MollieResult<OrganizationResponse>> GetOrganizationAsync(string organizationId, CancellationToken cancellationToken = default) {
        ...
        public async Task<MollieResult<OrganizationResponse>> GetOrganizationAsync(UrlObjectLink<OrganizationResponse> url, CancellationToken cancellationToken = default) {
            return await GetAsync(url, cancellationToken: cancellationToken).ConfigureAwait(false);
        }

        public async Task<MollieResult<ListResponse<OrganizationResponse>>> GetOrganizationListAsync(string? from = null, int? limit = null, CancellationToken cancellationToken = default) {
        ...
        public async Task<MollieResult<ListResponse<OrganizationResponse>>> GetOrganizationListAsync(UrlObjectLink<ListResponse<OrganizationResponse>> url, CancellationToken cancellationToken = default) {
            return await GetAsync(url, cancellationToken: cancellationToken).ConfigureAwait(false);
        }

        public async Task<MollieResult<PartnerResponse>> GetPartnerStatusAsync(CancellationToken cancellationToken = default) {
